...
multiplicator_enemy_open_four = 50_500_000
multiplicator_enemy_semi_closed_four = 50_000_000

multiplicator_open_four = 10_000_000

# multiplicator_enemy_open_four = 2_500_000
# multiplicator_enemy_semi_closed_four = 2_000_000
multiplicator_enemy_open_three = 8_000_000
multiplicator_open_three = 4_000_000

# multiplicator_enemy_open_three = 1_000_000
# multiplicator_open_three = 500_000
multiplicator_semi_closed_four = 20_000
multiplicator_enemy_semi_closed_three = 0
multiplicator_semi_closed_three = 0
# multiplicator_enemy_semi_closed_three = 10_000
# multiplicator_semi_closed_three = 5_000
multiplicator_open_two = 20
multiplicator_semi_closed_two = 0
# multiplicator_semi_closed_two = 5
multiplicator_enemy_semi_closed_two = 0
# multiplicator_enemy_semi_closed_two = 10
...
def check_line(line, starting_index, player, player_eat, enemy_eat):
    ...
    if r_empty_space:
        ...
        if r_additional_enemy != 0:
            if r_consecutive_enemy + r_additional_enemy == 2:
                enemy_open_three += 1
    ...
    if l_empty_space:
        ...
        if l_additional_enemy != 0:
            if l_consecutive_enemy + l_additional_enemy == 2:
                enemy_open_three += 1
    ...
    if open_eat_move:
        score += eat_value(open_eat_move + player_eat)
...
def get_new_threats(board, position, maximizing_player, player, player_eat, enemy_eat, depth):
    ...
    if print_values:
        print("LR")
    # result_lr, capture_left_lr, capture_right_lr = check_line(lr_diags, col_index, player, player_eat, enemy_eat)
