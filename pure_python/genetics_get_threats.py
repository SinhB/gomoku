...
@njit("(int64)(boolean, int64, int64, int64, int64, int64, int64, int64, int64, int64, int64, int64, int64, int64, int64)", fastmath=True)
def get_score(
    has_empty,
    semi_closed_two,
    open_two,
...
def get_new_threats(board, position, maximizing_player, player, player_eat, enemy_eat, depth, eat_multiplicators, multiplicators):
    ...
    is_win = True if eat_move + player_eat or five_lr or five_rl or five_row or five_col else False
