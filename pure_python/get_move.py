...
def minimax(board, depth, alpha, beta, maximizing_player, score, max_depth, player, total_eat, is_win):
    if depth == 0 or is_win:
        return score
        # return get_new_threats(board, p, maximizing_player, player, total_eat[player], total_eat[player * -1], depth)
    ...
    if maximizing_player:
        ...
        for position, new_score, captured_stones, is_win, _, new_eat in best_position:
            ...
            evaluation = minimax(board, depth - 1, alpha, beta, False, new_score, max_depth, player, total_eat, is_win)
            total_eat[player] -= new_eat
        ...
        for position, new_score, captured_stones, is_win, _, new_eat in best_position:
            ...
            total_eat[-player] += new_eat
            evaluation = minimax(board, depth - 1, alpha, beta, True, new_score, max_depth, player, total_eat, is_win)
            total_eat[-player] -= new_eat
